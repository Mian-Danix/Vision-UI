    ...
    <section className="col-span-3 bg-[linear-gradient(126.97deg,rgba(6,11,40,0.74)_28.26%,rgba(10,14,35,0.71)_91.2%)] text-white md:p-[1.50vw] p-5 rounded-lg shadow-md">
      ...
      <div className="flex flex-col text-[1.15vw] md:gap-[.75vw] gap-2">
        <div className="flex flex-col">
          <div>
            <span className="text-blue-300 md:mr-[.75vw] mr-2">💰</span>
            <span className="text-xl md:text-[1.25vw]">
              $2400, Design changes
            </span>
          </div>
          <span className=" text-gray-300 md:ml-[2.5vw] ml-8">
            22 DEC 7:20 PM
          </span>
        </div>
        ...
        <div className="flex flex-col ">
          <div>
            <span className="text-red-400 md:mr-[.75vw] mr-2">🔔</span>
            <span className="text-xl md:text-[1.25vw]">New order #4219423</span>
          </div>
          <span className=" text-gray-300 md:ml-[2.5vw] ml-8">
            21 DEC 11:21 PM
          </span>
        ...
        <div className="flex flex-col">
          <div>
            <span className="text-yellow-400 md:mr-[.75vw] mr-2">💳</span>
            <span className="text-xl md:text-[1.25vw]">
              New card added for order{" "}
            </span>
          </div>
          <span className="md:ml-[2.5vw] ml-8 text-gray-300">
            20 DEC 3:52 PM
          </span>
        </div>
